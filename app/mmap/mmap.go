...
//	* specifying a filesz larger than the file's actual filesz can increase the file's filesz
...
// The offset parameter must be a multiple of the system's page filesz.
// If length < 0, the entire file will be mapped.
// If ANON is set in flags, f is ignored.
func MapRegion(f *os.File, length int, prot, flags int, offset int64) (MMap, error) {
	if offset%int64(os.Getpagesize()) != 0 {
		return nil, errors.New("offset parameter must be a multiple of the system's page filesz")
	}
...
func header(m []byte) *reflect.SliceHeader {
	return (*reflect.SliceHeader)(unsafe.Pointer(&m))
}