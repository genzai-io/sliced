...
We use [Github issues](https://github.com/genzai-io/sliced/common/zfs/issues) to track bug reports, feature requests, and submitting pull requests.
...
[Fork the project](https://help.github.com/articles/fork-a-repo), clone your fork, and add the upstream to your remote:
    ...
    $ cd go-zfs
    $ git remote add upstream https://github.com/genzai-io/sliced/common/zfs.git
